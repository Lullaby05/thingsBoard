...
export const MediaBreakpoints = {
  ...
  "md-lg": navigator.userAgent.includes("Electron")
    ? "screen and (min-width: 1920px)"
    : "screen and (min-width: 960px) and (max-width: 1819px)",
};
...
export const HelpLinks = {
  linksMap: {
    ...
    ruleNodeJsSwitch:
      helpBaseUrl +
      "/docs/user-guide/rule-engine-2-0/filter-nodes/#switch-node",
    ...
    ruleNodeMsgDelay:
      helpBaseUrl + "/docs/user-guide/rule-engine-2-0/action-nodes/#delay-node",
    ...
    ruleNodeLog:
      helpBaseUrl + "/docs/user-guide/rule-engine-2-0/action-nodes/#log-node",
    ...
    ruleNodeOutputNode:
      helpBaseUrl + "/docs/user-guide/rule-engine-2-0/flow-nodes/#output-node",
    ruleNodeAwsSns:
      helpBaseUrl +
    ...
    ruleNodeKafka:
      helpBaseUrl +
      "/docs/user-guide/rule-engine-2-0/external-nodes/#kafka-node",
    ruleNodeMqtt:
      helpBaseUrl +
      "/docs/user-guide/rule-engine-2-0/external-nodes/#mqtt-node",
    ruleNodeAzureIotHub:
      helpBaseUrl +
    ...
    ruleNodeCalculateDelta:
      helpBaseUrl +
      "/docs/user-guide/rule-engine-2-0/enrichment-nodes/#calculate-delta",
    ...
    widgetsConfig:
      helpBaseUrl + "/docs/user-guide/ui/dashboards#widget-configuration",
    widgetsConfigTimeseries:
      helpBaseUrl + "/docs/user-guide/ui/dashboards#timeseries",
    ...
    ruleNodePushToEdge:
      helpBaseUrl +
      "/docs/user-guide/rule-engine-2-0/action-nodes/#push-to-edge",
    queue: helpBaseUrl + "/docs/user-guide/queue",
    repositorySettings:
      helpBaseUrl +
      "/docs/user-guide/version-control/#git-settings-configuration",
    autoCommitSettings:
      helpBaseUrl + "/docs/user-guide/version-control/#auto-commit",
    twoFactorAuthentication:
      helpBaseUrl + "/docs/user-guide/two-factor-authentication",
    sentNotification:
      helpBaseUrl + "/docs/user-guide/notifications/#send-notification",
    templateNotifications:
      helpBaseUrl + "/docs/user-guide/notifications/#templates",
    recipientNotifications:
      helpBaseUrl + "/docs/user-guide/notifications/#recipients",
    ruleNotifications: helpBaseUrl + "/docs/user-guide/notifications/#rules",
    jwtSecuritySettings:
      helpBaseUrl + "/docs/user-guide/ui/jwt-security-settings/",
  },
};
